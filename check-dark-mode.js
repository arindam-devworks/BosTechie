...
for (const file of files) {
    ...
    lines.forEach((line, i) => {
        // Find things like text-slate-900 or bg-white without dark:[type]
        if (line.includes('text-slate-900') || line.includes('text-gray-900')) {
        ...
        if (line.includes('bg-white ') || line.includes('bg-white"') || line.includes("bg-white'") || line.includes('bg-white`')) {
