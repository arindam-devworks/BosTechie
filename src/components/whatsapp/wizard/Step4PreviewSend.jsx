...
export default function Step4PreviewSend({ data, onSend }) {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex-1 mt-2 md:mt-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px] md:rounded-[40px] p-6 md:p-10 shadow-sm space-y-10">
                <div>
