...
export default function WhatsAppEditorForm({ templateId, variables, onChangeVariable }) {
        ...
        return (
            <div className="flex-1 flex items-center justify-center p-8 bg-slate-50/30 rounded-3xl border-2 border-dashed border-slate-100 h-full">
                <div className="text-center max-w-sm">
                    ...
                    <h4 className="text-[13px] font-black text-slate-900 dark:text-white uppercase tracking-widest mb-2">Configure Campaign</h4>
    ...
    return (
        <div className="flex flex-col h-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h3 className="text-[12px] font-black text-slate-900 dark:text-white uppercase tracking-[0.2em] flex items-center gap-3 mb-6">
                <div className="w-2 h-2 rounded-full bg-primary-500 shadow-[0_0_10px_rgba(99,102,241,0.5)]"></div>
                Variable Mapping
            </h3>

            <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar pr-1">
                <div className="p-4 md:p-5 bg-slate-50 dark:bg-slate-800/50 rounded-[24px] border border-slate-100/50 dark:border-slate-700/50 transition-all hover:bg-white dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-700 hover:shadow-sm">
                    ...
                    <input
                        ...
                        className="w-full p-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-[12px] md:text-[13px] font-bold text-slate-900 dark:text-white focus:border-primary-500 outline-none transition-all shadow-sm placeholder:text-slate-300 dark:placeholder:text-slate-500"
