...
export default function Sidebar() {
    ...
    return (
        <aside className="w-20 lg:w-72 bg-slate-900/95 backdrop-blur-xl text-white flex flex-col h-full border-r border-white/5 relative z-40 transition-all duration-500 ease-in-out">
            {/* Orbit Branding */}
            <div className="p-8 flex items-center justify-center lg:justify-start">
                ...
                <div className="hidden lg:block ml-4 overflow-hidden">
                    <h1 className="text-xl font-black tracking-tighter text-white leading-none uppercase">Bostechei</h1>
                ...
                {links.map((link) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="hidden lg:block font-bold text-[13px] uppercase tracking-wider truncate">{link.label}</span>
                        </NavLink>
                    );
                })}
            </nav>
            ...
            <div className="p-8 border-t border-white/5 mt-auto">
                <div className="hidden lg:flex items-center gap-3 p-3 bg-white/5 rounded-2xl border border-white/5">
                ...
                <p className="hidden lg:block text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-4">© 2026 Bostechei</p>
            </div>
        </aside>
    );
}
